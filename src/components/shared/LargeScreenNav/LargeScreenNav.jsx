...
const LargeScreenNav = ({ navOptions = null, modifyClasses = "" }) => {
  // link Classes
  const linkClasses =
    "block leading-[normal] rounded-default p-2 transition-all duration-default hover:text-primary font-medium 3xl:text-xl";

  return (
    <nav className={`flex justify-center ${modifyClasses}`}>
      <ul className="flex gap-1 xl:gap-3 items-center">
